...
namespace Repository_TechCompass.Interfaces
{
    public interface IAssessmentRepository
    {
        ...
        // ĐỔI SANG DÙNG SESSION
        Task<AssessmentSession?> GetAssessmentSessionByIdAsync(Guid sessionId);
        Task<AssessmentSession?> GetLatestAssessmentSessionByNodeAsync(Guid studentId, int skillNodeId);
        Task<List<AssessmentSession>> GetAssessmentSessionsByStudentAsync(Guid studentId);
